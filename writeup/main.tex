...
\caption{Level 1 train results for linear regression (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/linear/level1/test-o3.tex}
\caption{Level 1 test results for linear regression (O3)}
\end{table}
...
\caption{Level 2 train results for linear regression (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/linear/level2/test-no2.tex}
\caption{Level 2 test results for linear regression (NO2)}
\end{table}
...
\caption{Level 2 train results for linear regression (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/linear/level2/test-o3.tex}
\caption{Level 2 test results for linear regression (O3)}
\end{table}
...
\caption{Level 3 train results for linear regression (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/linear/level3/test-no2.tex}
\caption{Level 3 test results for linear regression (NO2)}
\end{table}
...
\caption{Level 3 train results for linear regression (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/linear/level3/test-o3.tex}
\caption{Level 3 test results for linear regression (O3)}
\end{table}
...
\caption{Level 0 train results for NN-2 (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-2/level0/test-no2.tex}
\caption{Level 0 test results for NN-2 (NO2)}
\end{table}
...
\caption{Level 0 train results for NN-2 (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-2/level0/test-o3.tex}
\caption{Level 0 test results for NN-2 (O3)}
\end{table}
...
\caption{Level 1 train results for NN-2 (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-2/level1/test-no2.tex}
\caption{Level 1 test results for NN-2 (NO2)}
\end{table}
...
\caption{Level 1 train results for NN-2 (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-2/level1/test-o3.tex}
\caption{Level 1 test results for NN-2 (O3)}
\end{table}
...
\caption{Level 2 train results for NN-2 (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-2/level2/test-no2.tex}
\caption{Level 2 test results for NN-2 (NO2)}
\end{table}
...
\caption{Level 2 train results for NN-2 (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-2/level2/test-o3.tex}
\caption{Level 2 test results for NN-2 (O3)}
\end{table}
...
\caption{Level 3 train results for NN-2 (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-2/level3/test-no2.tex}
\caption{Level 3 test results for NN-2 (NO2)}
\end{table}
...
\caption{Level 3 train results for NN-2 (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-2/level3/test-o3.tex}
\caption{Level 3 test results for NN-2 (O3)}
\end{table}
...
\caption{Level 0 train results for NN-4 (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-4/level0/test-no2.tex}
\caption{Level 0 test results for NN-4 (NO2)}
\end{table}
...
\caption{Level 0 train results for NN-4 (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-4/level0/test-o3.tex}
\caption{Level 0 test results for NN-4 (O3)}
\end{table}
...
\caption{Level 1 train results for NN-4 (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-4/level1/test-no2.tex}
\caption{Level 1 test results for NN-4 (NO2)}
\end{table}
...
\caption{Level 1 train results for NN-4 (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-4/level1/test-o3.tex}
\caption{Level 1 test results for NN-4 (O3)}
\end{table}
...
\caption{Level 2 train results for NN-4 (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-4/level2/test-no2.tex}
\caption{Level 2 test results for NN-4 (NO2)}
\end{table}
...
\caption{Level 2 train results for NN-4 (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-4/level2/test-o3.tex}
\caption{Level 2 test results for NN-4 (O3)}
\end{table}
...
\caption{Level 3 train results for NN-4 (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-4/level3/test-no2.tex}
\caption{Level 3 test results for NN-4 (NO2)}
\end{table}
...
\caption{Level 3 train results for NN-4 (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/nn-4/level3/test-o3.tex}
\caption{Level 3 test results for NN-4 (O3)}
\end{table}
...
\caption{Level 0 train results for random forest (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/subu/level0/test-no2.tex}
\caption{Level 0 test results for random forest (NO2)}
\end{table}
...
\caption{Level 0 train results for random forest (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/subu/level0/test-o3.tex}
\caption{Level 0 test results for random forest (O3)}
\end{table}
...
\caption{Level 1 train results for random forest (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/subu/level1/test-no2.tex}
\caption{Level 1 test results for random forest (NO2)}
\end{table}
...
\caption{Level 1 train results for random forest (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/subu/level1/test-o3.tex}
\caption{Level 1 test results for random forest (O3)}
\end{table}
...
\caption{Level 2 train results for random forest (NO2)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/subu/level2/test-no2.tex}
\caption{Level 2 test results for random forest (NO2)}
\end{table}
...
\caption{Level 2 train results for random forest (O3)}
\end{table}
\begin{table}[H]
\centering
\scriptsize
\input{\baselinedir/subu/level2/test-o3.tex}
\caption{Level 2 test results for random forest (O3)}
\end{table}
